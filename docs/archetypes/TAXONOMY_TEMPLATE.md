...
13. **Grounding.** Research citation, or **engineering-observed** mark + pilot-validation flag (§7; gold §2.7, §2.13 precedent).
...
1. **Grounding or the flag.** Every entry cites its research tradition; thin-literature entries are marked **engineering-observed** and flagged for pilot validation (gold §1 condition 4; §2.7 and §2.13 precedent). An unflagged thin entry is an audit defect.
