...
7. Skin safety: presentation-class flips can silently re-key diagnosis; **RESOLVED 2026-07-06** — INTEREST_DOMAINS §4 now freezes presentation class (frozen locally in embedded-check, required per-entry in TAXONOMY_TEMPLATE). *(Was: INTEREST_DOMAINS patch pending.)*
