// scripts/merge-equations-banks.mjs
// One-off content-debt batch 2 merge (mr-kahn authored and approved all content):
// merges the 14 equations problem-bank fragments in .authoring-tmp/ALG-E01.json
// … ALG-E14.json into data/algebra1-graph.json, then bumps schema.version to 1.4.0.
...
// Run once: node scripts/merge-equations-banks.mjs
...
const ACCEPTED_VERSIONS = new Set(["1.3.1"]);
...
console.log(
  `Merged ${fragments.length} equations banks (${totalProblems} problems, ` +
