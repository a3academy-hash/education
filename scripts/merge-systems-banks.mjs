// scripts/merge-systems-banks.mjs
// One-off content-debt batch 4 merge (mr-kahn authored and approved all content):
// merges the 6 systems-domain problem-bank fragments in .authoring-tmp/ALG-S01.json
// … ALG-S06.json into data/algebra1-graph.json, then bumps schema.version to 1.6.0.
...
// Run once: node scripts/merge-systems-banks.mjs
...
const ACCEPTED_VERSIONS = new Set(["1.5.1"]);
...
console.log(
  `Merged ${fragments.length} systems banks (${totalProblems} problems, ` +
